...
pipenv run firerock 5da1800e87b64fb6f4c32503 --date 2019-10-30-m --hours 9 11 10,13-14 --minutes 30-59 0-29 *  -m -d -t
pipenv run firestone 000993 000001 --date 2019-10-30 --hours 9 11 10,13-14 --minutes 30-59 0-29 * -m -d -v