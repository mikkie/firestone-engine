...
rem mongo 127.0.0.1/firestone-data --eval "db.getCollection('000993-2019-10-30').drop(); db.getCollection('000001-2019-10-30').drop();" "c:/aqua/firestone-engine/tests/e2e/basic/data.js"
...
start pipenv run firestone 000993 000001 --date 2019-10-30 --hours %time:~0,2% --minutes * -m -v