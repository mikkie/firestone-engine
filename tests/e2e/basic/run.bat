...
start pipenv run firerock 5da1800e87b64fb6f4c32503 --date 2019-10-30-m --hours %time:~0,2% --minutes 7-25  -m -t -v -i
start pipenv run firestone 000993 000001 --date 2019-10-30 --hours %time:~0,2% --minutes 7-25 -m -v